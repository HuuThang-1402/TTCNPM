...
{
    public partial class MonHue : UserControl
    {
        private static MonHue _instance;
        public static MonHue Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new MonHue();
                return _instance;
            }
        }
        public MonHue()
        ...
        public static int MonHueo = 0;
        public void button1_Click(object sender, EventArgs e)
        {
            DatMonForm.MonHueF = 1;
            MonHueo = 1;
